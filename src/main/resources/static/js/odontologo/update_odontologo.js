  ...
  formulario.addEventListener("submit", function (e) {
    ...
    fetch(url, settings)
      ...
      .then((data) => {
        console.log(data);
        let successAlert =
          '<div class="alert alert-success alert-dismissible">' + '<button type="button" class="close" data-dismiss="alert">&times;</button>' + "<strong></strong> Odontólogo Actualizado </div>";
