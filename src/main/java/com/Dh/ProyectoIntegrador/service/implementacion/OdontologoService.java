...
public class OdontologoService implements IService<Odontologo> {
	...
	public Odontologo guardar(Odontologo odontologo) throws OdontologoException, DomicilioException, PacienteException {
	...
	public void actualizar(Odontologo odontologo) throws OdontologoException, DomicilioException, PacienteException { this.iDao.actualizar(odontologo); }

	public Odontologo buscarPorId(Integer  id) throws OdontologoException, DomicilioException, PacienteException { return this.iDao.buscarPorId(id); }

	public List<Odontologo> listarTodos() throws OdontologoException, DomicilioException, PacienteException {
